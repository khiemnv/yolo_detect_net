...
namespace Yolov
{
    public class PredictionBox : IBox
    {
        ...
        public float score;
        public int index;
        public List<PointF> poses;
        public List<System.Drawing.PointF> _points;
        ...
        public IEnumerable<System.Drawing.PointF> Points => _points;
    ...
    public class PredictionBoxCollection
    {
        public List<PredictionBox> boxes;
        public int w;
        public int h;
    }
}