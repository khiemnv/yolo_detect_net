...
namespace Yolov
{
    public class VinoYolo8 : YoloModelBase
    {
        ...
        protected override void ReadModel(string xml)
        {
            ...
            ModelInputHeight = (int)input_shape[2];
            ModelInputWidth = (int)input_shape[3];
        ...
        public override PredictionBoxCollection Detect(string image_path)
        {
            ...
            infer_request.infer();
            var pbc = ParseOutput((image.Width, image.Height), factor);
            return pbc;
        }
        ...
        private List<SegmentationBoundingBox> ParseSegOutput((int Width, int Height) image, float factor)
        {
            ...
            var modelSize = new SixLabors.ImageSharp.Size(ModelInputWidth, ModelInputHeight);
        ...
        {
            var bitmap = new SixLabors.ImageSharp.Image<SixLabors.ImageSharp.PixelFormats.L8>(maskWidth, maskHeight);
